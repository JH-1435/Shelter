...
function fileCheck(obj) {
	...
	if(fileType == "jpg" || fileType == "gif" || fileType == "png" || 
		...
		//input 파일 초기화 => id가  file = null값 넣음
		...
		<div class="contents">
			<div class="a-table view02">
				...
				<tr class="content-text">
					...
					<td colspan="1"><input name="animalTitle" type="text" value="${item.animalTitle}">
				</tr>
				<tr class="content-text">
					<th><label>품종</label></th>
					<td colspan="1"><input name="animalName" type="text" value="${item.animalName}">
				</tr>
				<tr class="content-text">
					<th><label>성별</label></th>
					<td colspan="1"><input name="animalSex" type="text" value="${item.animalSex}">
				</tr>
				<tr class="content-text">
					<th><label>발견장소</label></th>
					<td colspan="1"><input name="animalLocation" type="text" value="${item.animalLocation}">
				</tr>
				<tr class="content-text">
					<th><label>나이</label></th>
					<td colspan="1"><input name="animalAge" type="text" value="${item.animalAge}">
				</tr>
				<tr class="content-text">
					<th><label>상태</label></th>
					<td colspan="1"><input name="animalState" type="text" value="${item.animalState}">
				</tr>
				<tr class="content-text02">
					<th><label>구조일</label></th>
					<td colspan="1"><input name="animalRegDate" type="date" value="${item.animalRegDate}">
					<label>현재 구조일: 
					<fmt:formatDate pattern="yyyy-MM-dd" value="${item.animalRegDate}"/></label></td>	
				</tr>	
