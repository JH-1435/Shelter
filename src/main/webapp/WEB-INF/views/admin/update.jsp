...
<div id="#container-wrap">
	...
	<!------ left-nav ------>
		...
		<div class="contents">
			...
			<tbody>
				<tr class="content-text">
					...
					<td colspan="1"><input name="adminId" type="text" value="${item.adminId}"></td>
				</tr>
				<tr class="content-text">
					<th><label>이름:</label></th>
					<td colspan="1"><input name="adminName" type="text" value="${item.adminName}"></td>
				</tr>
		...
		<div class="btn-group">
			<a href="/admin/list"><i class="fas fa-bars"></i>취소</a>
		</div>	
		</div>
	</div>
	<!---- 컨텐츠내용 ---->
...
<div id="overflow-hidden-admin03"></div>
