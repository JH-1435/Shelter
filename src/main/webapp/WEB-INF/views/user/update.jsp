...
<div class="nav-color">
		...
		<ul class="nav-list">
				...
				<li><a href="/board/list" class="on">입양신청</a></li>
			</ul>
		</nav>
		</div>
</header>
...
<div id="#container-wrap">
	...
	<!------ left-nav ------>
		...
		<div class="contents">
			...
			<tbody>
				<tr>
					<th class="av-1"><label>아이디:</label></th>
					<td class="av-1">${item.userId}</td>
				</tr>
				<tr class="content-text">
					<th><label>이름:</label></th>
					<td colspan="1"><input name="userName" type="text" value="${item.userName}"></td>
				</tr>
				<tr class="content-text">
					<th><label>전화번호:</label></th>
					<td colspan="1"><input name="userTel" type="number" value="${item.userTel}" placeholder=" '-'을 제외한 휴대폰번호를 입력해 주세요">
					</td>
				</tr>
				<tr class="content-text">
					<th><label>주소:</label></th>
					<td colspan="1"><input name="userAddress" type="text" value="${item.userAddress}"></td>
				</tr>
				<tr class="content-submit">
					<td colspan="5"><input type="submit" value="변경완료">
				</tr>
				</tbody>
			</table>
		</form>
	...
	<div id="overflow-hidden-admin04"></div>
